...
if perda_agua_input and crocancia_input and modelos_input:
    try:
        ...
        # Verificar se o número de modelos corresponde ao número de entradas de dados
        if len(modelos) != len(perda_agua):
            st.error("O número de modelos e perdas de água deve ser o mesmo.")
        else:
